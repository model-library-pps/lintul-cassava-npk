...
from lintul_cassava.lintul_cassava_soil import soil_water_dynamics, soil_water_dynamics_PP
from lintul_cassava.lintul_cassava_soil_nutrient_dynamics import soil_nutrient_dynamics, soil_nutrient_dynamics_PP
